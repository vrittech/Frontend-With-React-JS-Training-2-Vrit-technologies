         ...
         <div className="h-screen bg-gray-100">
            ...
            <div className="mx-auto  justify-center px-6 md:flex md:space-x-6 xl:px-0">
                        ...
                        <tbody>
                           {products.map(product => (
                              <tr key={product._id}>
                                 <td className="py-2">
                                    <div className="flex items-center">
                                       <div className="w-12 h-16 p-1 border border-gray-300 rounded-lg flex items-center justify-center">
                                          <img className="max-w-full max-h-full" src={product.images[0]} alt="" />
                                       </div>
                                 ...
                                 <td>
                                    <div className="flex items-center">
                                       <button className="px-2 py-1" onClick={(e) => removeFromCart(e, product._id)}>-</button>
                                       <span className="px-2">{cartProduct.filter(id => id === product._id).length}</span>
                                       <button className="px-2 py-1" onClick={(e) => addToCart(e, product._id)}>+</button>
                                    </div>
                                 </td>
               ...
               <div className="mt-6 w-full h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 ">
                  ...
                  <button className=" w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600" onClick={goToPayment}>
                     Check out</button>
               </div>
            </div>
         </div>
